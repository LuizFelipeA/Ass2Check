...
# Modified by: Chris Johnson <chris.johnson@senecapolytechnic.ca>
...
echo "a2output.txt has been created in your home directory."
echo "Please submit it to the Assignment 2 submission item on BlackBoard."